  ...
  if (styleType === "primary") {
    return (
      <Pressable
        ...
        className={`mb-14 ${enabled ? "bg-secondary" : "bg-disabled"} mx-4 py-4 rounded-2xl`}
      >
    ...
    return (
      <Pressable
        onPress={enabled ? onPress : undefined}
        className="mb-14 border-2 border-solid border-[#fffefc] bg-transparent px-1 py-1 rounded-lg"
      >
